...
class InvestmentEngine:
    ...
    async def _calculate_opportunity_score(
        ...
        try:
            ...
            confidence_component = (sentiment_confidence + ml_confidence) / 2 * confidence_weight
    ...
    async def _determine_action_and_size(
        ...
        try:
            ...
            if ml_direction == 'bullish' and total_score > 0.6:
                action = 'buy'
            elif ml_direction == 'bearish' and total_score > 0.6:
                action = 'sell'
            elif ml_direction == 'bullish' and total_score > 0.4:
                action = 'buy'
            elif ml_direction == 'bearish' and total_score > 0.4:
                action = 'sell'
            else:
                action = 'hold'
